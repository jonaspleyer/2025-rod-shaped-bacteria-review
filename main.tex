...
\keywords{Individual-Based \and Cell \and Biology}

\textbf{POSSIBLE TITLES}
\begin{itemize}
    \item Bridging the Gap: From single-cell essays to collective phenomena - mechanical properties
        of rod-shaped bacteria
    \item Mathematical models of rod-shaped bacteria - From single-cell analyses to collective
        phenomena
\end{itemize}
