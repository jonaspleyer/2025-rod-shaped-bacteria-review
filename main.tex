...
\begin{itemize}
    ...
    \item adding to first point \cite{Koch1995} central FtsZ-ring assembly is favored by mechanical forces. Its regulation is thereby a combination of mechanical cues and biochemical regulation.
...
\todo{@ Toqi: Sort it in one paragraph}
...
\todo{@ Toqi: Sort it in one paragraph}
\cite{Amir2014_2} 
\cite{Wang2010,Wang2010_protocol}
\cite{Chatterjee1988}
