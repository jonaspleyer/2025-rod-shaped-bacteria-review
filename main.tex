...
\begin{itemize}
    ...
    \item \cite{Wang2010} MreB and \ac{pg} contributes to nearly equal parts to the stiffness of a cell
...
\textbf{[Note (Jonas)]}
\paragraph{Cells are flexible/filamentous, not always straight} \todo{@Joans do you want to keep this like that, all citations are also sorted in the pullet points}
...
\begin{itemize}
    ...
    \item \textbf{adhesion}
    \item \cite{BrettFinlay2014} Adhesins, pili/fimbriae, and surface proteins mediate the binding to \ac{ecm} components
    \item Type IV pili \cite{Ellison2021} or flagella in general \cite{Haiko2013} are more then force-generating structures that coordinate bacterial movement, they play an important role in the direct adhesion, and environmental interaction
\end{itemize}

\paragraph{Pathogens}
\begin{itemize}
    \item \cite{Duckworth2002} Bacteriophages (phages) are viruses of bacteria that can kill and lyse the bacteria they infect and disrupt biofilm
    \item \cite{Barrangou2007} CRISPR provides adaptive resistance against bacteriophages in prokaryotes \todo{do we need more details, like: spacers derived from phage genomic sequences are integrated with resistance specificity determined by spacer-phage sequence similarity; Move to adaptations?}
    \item \cite{Borges2017} some protein families have anti-CRISPR function
\end{itemize}
...
\begin{itemize}
    ...
    \item \cite{Barrangou2007} CRISPR provides adaptive resistance against bacteriophages \cite{Duckworth2002} in prokaryotes
...
\begin{itemize}
    ...
    \item \cite{Nikita2009, Bourret2002} Chemotaxis, is the most makecommon and best studied form of taxis. It is a receptor-mediated signaling network that integrates external chemical cues to modulate flagellar motion and control movement direction.
\end{itemize}
...
B. subtilis forms endospore \cite{Errington2020}
