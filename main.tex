...
\begin{itemize}
    ...
    \item \textbf{adhesion}
    \item \cite{BrettFinlay2014, Berne2018} Adhesins, pili/fimbriae, and surface proteins mediate the binding to \ac{ecm} components/ adhesion is a highly heterogeneous and dynamic process
...
\begin{itemize}
    \item \cite{MorenoGmez2023} Quorum sensing as a mechanism to harness the wisdom of the crowds
    \item \cite{Liu2025} Quorum Sensing: Not Just a Bridge Between Bacteria
    \item \cite{Boyer2009} "Many factors other than cell density were shown to affect N-acyl-homoserine lactones accumulation and interfere with the QS signalling process." "This review aims to resent all factors interfering with the AHL-mediated signalling process, at the levels of signal production, diffusion and perception."
\end{itemize}

\paragraph{Differentiation \& Fruiting bodies and sporilation}
\todo{think about shuffling it to previous section}
\begin{itemize}
    \item \cite{Jose2016} some bacterial can have lifecycle Myxococcus xanthus \cite{Branda2001} \ac{bsubtilis}
e.g for task division
    \item \cite{Huan2021} Sporulation and Germination of M. xanthus. Myxococcus xanthus degrade their PG and form spherical spores - germination reconstruct their PG layer and regain their rod shape without relying on any preexisting structural template - sphere to rod 
    \item starvation-dependent and starvation-independent pathways of sporulation and produce structurally different spores \cite{Licking2000} B. subtilis can divide asymmetrically during sporulation one cell differentiation process \cite{Barák2019}
\end{itemize}
...
\paragraph{Adhesion}\todo{Rethink if this is not better with adhesion paragraph?}
...
\paragraph{Adhesion in biofilms}
