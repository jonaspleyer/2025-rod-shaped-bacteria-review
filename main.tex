...
\subsubsection{Modeling Frameworks}
...
\begin{table}
    ...
    \begin{minipage}{0.6\textwidth}
        \begin{tabularx}{\textwidth}{ll}
            ...
            Other & (Fix) Fixed model choice, (U) User definable\\
            \bottomrule
        \end{tabularx}
    \end{minipage}%
\end{table}
...
\subsubsection{Promising Candidates}
\begin{itemize}
