...
some bacteria can fuse to each other when they are long enough at close distance \cite{Kudryashev2011} \todo{do we need this, if yes we need more citations}
...
\begin{itemize}
    ...
    \item \cite{Huan2021} Myxococcus xanthus sporulat and make fruiting bodies. They have starvation-dependent and starvation-independent pathways of sporulation and produce structurally different spores \cite{Licking2000}
    ...
    \item \cite{Flemming2016} cellular differentiation in biofilms (matrix production, motility, sporulation)
\end{itemize}

\paragraph{Spacial Colonie Organizationn}
\begin{itemize}
