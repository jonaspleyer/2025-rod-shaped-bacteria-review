...
\begin{itemize}
    ...
    \item \ac{a22} treated cells \cite{IWAI2002}, \textit{rodZ} deletion mutants \cite{Shiomi2008} and \ac{mre} mutants \cite{Wachi1987} were found to induce spherical cells shape indicating that cell shape maintenance involves proteins encoded by the \ac{mre} like MreB or interacting with them
...
\begin{itemize}
    \item \cite{Takeuchi2005} changing \ac{ecoli} morphologie without altering any additional biochemical or genetic functions is automatically altering cell motility
...
\begin{itemize}
    ...
    \item \cite{Karczmarek2007} DNA and origin region segregation are not affected by the transition from rod to sphere after inhibition of Escherichia coli MreB by \ac{a22} 
\end{itemize}
