...
\begin{itemize}
    ...
    \item \cite{Bogdanowski2022} McComedy
    \item \cite{Lardon2011} iDynomics \textbf{TODO check how this can model rods (it should)}
    ...
    \item \cite{Rudge2012} CellModeller, has rod-shaped support and some predefined chemical
        reactions etc.
    \item \cite{Banitz2015,vanderWal2013} Netlogo (citations are only for specific applications, not Netlogo itself)
    \item \cite{Harcombe2014} COMETS \textbf{TODO}
\end{itemize}
...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{lccccccccc}
        ...
        \midrule
        AgentCell~\cite{Emonet2005} & & & & & & & & 2005\\
        ...
        CellModeller~\cite{Rudge2012} & & & & & & & & 2012\\ % has rod-shaped support and some predefined chemical reactions etc.\\
        COMETS~\cite{Harcombe2014} & & & & & & & & 2014\\
        DiSCUS~\cite{GoiMoreno2015} & & & & & & & & 2015\\
        \texttt{gro}~\cite{Gutirrez2017} & & & & & & & & 2017\\
        iDynomics~\cite{Lardon2011} & & & & & & & & 2011\\
        McComedy~\cite{Bogdanowski2022} & & & & & & & & 2022\\
        MultiCellSim~\cite{Dang2020} & & & & & & & & 2020\\
        Netlogo~\cite{Banitz2015,vanderWal2013} & & & & & & & & 2013\\
        NUFEB~\cite{Li2019} & & & & & & & & 2019\\
        Tisim/CellSys~\cite{Hoehme2010} & & & & & & & & 2010\\
        \bottomrule
    \end{tabularx}
    ...
    \begin{minipage}{0.6\textwidth}
        \begin{tabularx}{\textwidth}{ll}
            ...
            Intracellular & (O) \acp{ode}, (So) Stochastic \acp{ode}, (Discr) Discrete\\
