...
Here we first present the cell wall and cytoskeletal. Then how they are coupled. Then describe how they contribute in rod shape maintenance. To then give briefly mentioning other forms.
\paragraph{Cell Wall}
\begin{itemize}
...
\begin{itemize}
    ...
    \item e.g. for point before: \cite{Takeuchi2005} changed \ac{ecoli} morphologie without altering any additional biochemical or genetic functions and automatically altered cell motility
...
\begin{itemize}
    ...
    \item adding to first point \cite{Koch1995} central FtsZ-ring assembly is favored by mechanical forces . It's regulation is thereby a combination of mechanical cues and biochemical regulation.
