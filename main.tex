...
\begin{abstract}
    ...
    models which can be adjusted in order to include additional phenomena and are able to encompass
    the essential biological details that lead to a variety of collective effects
\end{abstract}
