...
\begin{abstract}
    ...
    biofilm formation.
    A key question is how single-cell processes link to the emergence of spatial phenomena.
...
\begin{itemize}
    ...
    \item \cite{Grimm2006} \textbf{TODO} "A standard protocol for describing individual-based and
        agent-based models" and update: \cite{Grimm2010}
\end{itemize}
...
\begin{itemize}
    ...
    \item \cite{Cooper2020} Chaste; no rods
    \item \cite{Starru2014} Morpheus
    \item \cite{Wei2013} BNSim
    \item 
\end{itemize}
